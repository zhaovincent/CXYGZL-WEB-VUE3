...
//TODO
//审批数据
let configDataAtStore = computed(() => store.subProcessConfigData)
...
<template>
  <node-template @updateData="updateParentData" place-holder-method-name="subProcessStr" check-method-name="subProcessOK" @open="open"   :node-config="nodeConfig"></node-template>
</template>
