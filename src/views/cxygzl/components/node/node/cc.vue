...
onMounted(() => {
  ...
  let checkCopy = $func.checkCopy(props.nodeConfig);


  props.nodeConfig.error = !(checkCopy.ok);
  props.nodeConfig.errorMsg = (checkCopy.msg);
...
//审批数据
let configData = computed(() => store.copyerConfig1)
