...
import ApprovalNode from "./node/approval.vue"
...
let showText = computed(() => {
	if (props.nodeConfig.type == 0) return $func.arrToStr(props.nodeConfig.nodeUserList) || '所有人'
	if (props.nodeConfig.type == 1) return $func.setApproverStr(props.nodeConfig)
	if (props.nodeConfig.type == 2) return $func.copyerStr(props.nodeConfig)
	return ""
});
...
watch(showText, (value, oldValue, onCleanup) => {
